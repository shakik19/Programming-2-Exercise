...
public abstract class AudioFile {
	...
	public static void checkReadability(String filepath) throws NotPlayableException {
		File file = new File(filepath);
		if (!file.canRead()){
			throw new NotPlayableException(filepath, "File not readable");
		}
	}
	...
	public String toString() {
		return (getAuthor().isEmpty()) ? getTitle() : getAuthor() + " - " + getTitle();
	}
}
